...
class AdminApprovedApplicationListTest extends TestCase
{
    use RefreshDatabase;

    // 管理者が全一般ユーザーの承認済み修正申請を確認できる
    public function test_admin_can_view_all_general_users_approved_applications(): void
    {
